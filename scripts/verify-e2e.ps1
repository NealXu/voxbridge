# ===========================================================================
# VoxBridge 端到端（Voice E2E）手动验证脚本
#
# 用法:
...
#   2. 打印手动验证清单（启动 VoxBridge -> 按 F9 -> 说 "create hello.py" -> 检查产物与 UI）
...
# 2.1
Ask-Manual -Step "启动 VoxBridge" -Instruction "在项目根目录执行 npm start，观察到就绪横幅「就绪，按 F9 说话」"
# 2.2
